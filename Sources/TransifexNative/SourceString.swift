...
public class TxSourceString: NSObject {
    /// The key that was generated by the `generateKey()` method
    let key: String
    /// The source string
    ...
    ///
    /// - Parameters:
    ///   - key: The key that was generated by the `generateKey()` method
